...
3. Используя <Импортирование конкретных функций из модуля> отредактируйте функцию generate_password, обращаясь к функциям модуля random --> choice и randint (Вам нужно импортировать только 2 функции)
